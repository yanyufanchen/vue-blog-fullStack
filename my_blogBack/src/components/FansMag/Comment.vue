      ...
      <div class="table">
        <div class="table">
          <el-table :data="tableData" border="" style="width: 100%">
            <el-table-column prop="date" label="发表日期" width="100"></el-table-column>
            <el-table-column prop="name" label="评论人" width="100"></el-table-column>
            <el-table-column prop="post" label="评论文章" width="150"></el-table-column>
            <!-- <el-table-column prop="city" label="市区" width="120"></el-table-column> -->
            <el-table-column prop="message" label="评论内容" min-width="200"></el-table-column>
